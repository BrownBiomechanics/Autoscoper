    ...
    methods
        ...
        function loadTrackingData(obj, volNum, tra_fileName, is_matrix, is_rows, is_csv, is_cm, is_rad, interpY)
            ...
            fwrite(obj.socket_descriptor, [ ...
                                           ...
                                           typecast(int32(is_matrix), 'uint8') ...
                                           typecast(int32(is_rows), 'uint8') ...
                                           typecast(int32(is_csv), 'uint8') ...
                                           typecast(int32(is_cm), 'uint8') ...
                                           typecast(int32(is_rad), 'uint8') ...
                                           typecast(int32(interpY), 'uint8') ...
                                           tra_fileName ...
                                          ]);
        ...
        function saveTrackingData(obj, volNum, tra_fileName, save_as_matrix, save_as_rows, save_csv, convert_mm_to_cm, convert_deg_to_rad, interpY)
            ...
            fwrite(obj.socket_descriptor, [ ...
                                           3 ...
                                           typecast(int32(volNum), 'uint8') ...
                                           typecast(int32(save_as_matrix), 'uint8') ...
                                           typecast(int32(save_as_rows), 'uint8') ...
                                           typecast(int32(save_csv), 'uint8') ...
                                           typecast(int32(convert_mm_to_cm), 'uint8') ...
                                           typecast(int32(convert_deg_to_rad), 'uint8') ...
                                           typecast(int32(interpY), 'uint8') ...
                                           tra_fileName ...
                                          ]);
            while obj.socket_descriptor.BytesAvailable == 0
        ...
        function setPose(obj, volNum, frame, pose)
            ...
            fwrite(obj.socket_descriptor, [ ...
                                           7 ...
                                           typecast(int32(volNum), 'uint8') ...
                                           typecast(int32(frame), 'uint8') ...
                                           typecast(double(pose), 'uint8') ...
                                          ]);
            while obj.socket_descriptor.BytesAvailable == 0
                pause(1);
            end
        ...
        function setBackground(obj, threshold)
            ...
            fwrite(obj.socket_descriptor, [ ...
                                           9 ...
                                           typecast(double(threshold), 'uint8') ...
                                          ]);
            while obj.socket_descriptor.BytesAvailable == 0
                pause(1);
            end
        ...
        function getImageCropped(obj, volNum, camera, frameNum)
            ...
            fwrite(obj.socket_descriptor, [ ...
                                           ...
                                           typecast(int32(volNum), 'uint8') ...
                                           typecast(int32(camera), 'uint8') ...
                                           typecast(double(frameNum), 'uint8') ...
                                          ]);
            while obj.socket_descriptor.BytesAvailable == 0
                pause(1);
            end
        ...
        function optimizeFrame(obj, volNum, frameNum, repeats, max_itr, min_lim, max_lim, max_stall_itr, dframe, opt_method, cf_model)
            ...
            fwrite(obj.socket_descriptor, [ ...
                                           ...
                                           typecast(int32(volNum), 'uint8') ...
                                           typecast(int32(frameNum), 'uint8') ...
                                           typecast(int32(repeats), 'uint8') ...
                                           typecast(int32(max_itr), 'uint8') ...
                                           typecast(double(min_lim), 'uint8') ...
                                           typecast(double(max_lim), 'uint8') ...
                                           typecast(int32(max_stall_itr), 'uint8') ...
