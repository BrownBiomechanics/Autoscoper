...
#if defined(Autoscoper_COLLISION_DETECTION) && defined(Autoscoper_COLLISION_DETECTION_WITH_VELOCITY_FILTER)
    float velClamp = 0.2;
    float speed = 0.0;
...
#endif // defined(Autoscoper_COLLISION_DETECTION) && defined(Autoscoper_COLLISION_DETECTION_WITH_VELOCITY_FILTER)
...
#if defined(Autoscoper_COLLISION_DETECTION) && defined(Autoscoper_COLLISION_DETECTION_WITH_COLLISION_RESPONSE)
...
#endif // defined(Autoscoper_COLLISION_DETECTION) && defined(Autoscoper_COLLISION_DETECTION_WITH_COLLISION_RESPONSE)
